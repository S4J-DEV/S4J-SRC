# نحو جستجو
SearchForJohn با یک متن جستجو همراه است که می توانید دسته ها را تغییر دهید،
...
SearchForJohn از ضربه های خارجی پشتیبانی می کند [DuckDuckGo] .  To مستقیماً به a
...
موتور، SearchForJohn نمی تواند از حریم خصوصی شما در این مورد محافظت کند.
